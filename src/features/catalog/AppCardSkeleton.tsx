      ...
      <div className="flex items-start sm:items-center gap-4 sm:gap-5 flex-1 min-w-0">
        ...
        <div className="flex-1 min-w-0 space-y-2.5">
          ...
          <div className="space-y-1.5">
            <div className="h-3.5 w-full max-w-lg rounded bg-slate-200/70 dark:bg-slate-800/70" />
            <div className="h-3.5 w-3/4 max-w-sm rounded bg-slate-100 dark:bg-slate-800/50 hidden sm:block" />
          </div>
